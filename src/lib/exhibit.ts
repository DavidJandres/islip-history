...
export const panelImages: Partial<Record<PanelSlug, PanelImage>> = {
  "the-promise": {
    ...
    altDe:
      "Das 1823 von William Stone gestochene Faksimile der Unabhängigkeitserklärung der Vereinigten Staaten von 1776, mit ihrem Text und den Unterschriften.",
    credit:
    ...
    captionDe:
      "Die Unabhängigkeitserklärung, wie sie William J. Stone 1823 im Stich festhielt, das bekannteste Bild des Textes von 1776 und seiner Unterschriften.",
  },
  "before-the-town": {
    ...
    altDe:
      "Eine Karte der kolonialen Provinz New York von 1779, mit ganz Long Island, die Grafschaften, Herrenhäuser, Patente, Townships und private Landvergaben zeigt.",
    credit:
    ...
    captionDe:
      "Diese Karte von 1779 zeigt die koloniale Provinz New York mit ganz Long Island. Islip liegt an der Südküste des Suffolk County, zwischen der Great South Bay und dem bewaldeten Inselinneren, aufgeteilt in große Privatgüter statt in Dörfer.",
  },
  "revolution-comes-to-islip": {
    ...
    altDe:
      "Eine Vermessungskarte der Provinz New York von 1776, mit ganz Long Island, der Region, die während der Revolution unter britische Besatzung geriet.",
    credit:
    ...
    captionDe:
      "Diese Vermessungskarte von 1776 zeigt Long Island zu Kriegsbeginn. Nach den Kämpfen bei Brooklyn im August 1776 kontrollierten britische Truppen alles auf dieser Karte östlich der Stadt, auch Islip.",
  },
  "washingtons-visit": {
    ...
    altDe:
      "Das lebensgroße Lansdowne-Porträt von Präsident George Washington, gemalt von Gilbert Stuart im Jahr 1796.",
    credit:
    ...
    captionDe:
      "Gilbert Stuarts Porträt von Präsident George Washington aus dem Jahr 1796, gemalt sechs Jahre nach seiner Reise über Long Island.",
  },
};
